  ...
  return (
    <div className="w-full max-w-3xl mx-auto pt-8 pb-12 flex justify-center">
      <div className="bg-[#f0e6d2] p-6 md:p-10 rounded shadow-2xl relative border-8 border-[#3b2f2f] paper-texture transform -rotate-1 transition-transform hover:rotate-0 duration-300 w-full">
        ...
        {/* Tape */}
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-48 h-8 bg-yellow-200 opacity-50 rotate-2 tape"></div>

        <h2 className="font-hand text-3xl mb-6 border-b-2 border-stone-400 pb-3 font-bold text-stone-800 tracking-wider">
          {t.seo.faqTitle}
        </h2>
        ...
        <div className="space-y-4 relative z-10">
          {faqs.map((faq, idx) => (
            ...
            >
              <summary className="cursor-pointer font-bold text-lg font-hand text-stone-800 hover:text-black transition-colors list-none flex justify-between items-center outline-none">
                  {faq.q}
